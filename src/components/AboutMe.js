...
function AboutMe() {
  return <Container>
    ...
    <p>
      I'm a new graduate out of UC Santa Cruz with a Bachelor's in Computer Science.
      I'm looking for full-time jobs as a Software Engineer in the Bay Area.
      I have experience with one internship in which I was developing a web/mobile app in a team.
      I worked on the frontend side, using ReactJS and Bootstrap to match my webpages to
